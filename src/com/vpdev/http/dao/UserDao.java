...
public class UserDao implements Dao<Integer, User> {
    ...
    private static final String SAVE_SQL =
            "INSERT INTO flight_repository.flight_storage.users (name, birthday, email, password, role, gender, image) VALUES (?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_BY_EMAIL_AND_PASSWORD_SQL =
            "SELECT * FROM flight_repository.flight_storage.users WHERE email = ? AND password = ?";
